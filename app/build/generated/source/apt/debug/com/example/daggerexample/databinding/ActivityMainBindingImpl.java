package com.example.daggerexample.databinding;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lblAwesome, 1);
        sViewsWithIds.put(R.id.txtUsername, 2);
        sViewsWithIds.put(R.id.txtPassword, 3);
        sViewsWithIds.put(R.id.btnLogin, 4);
        sViewsWithIds.put(R.id.lblResult, 5);
        sViewsWithIds.put(R.id.lblCredential, 6);
    }
    // views
    @NonNull
